...
export default function IdCardModalContainer({
  ...
  return (
    <div
      className={`${isOpen ? 'rotate-y-180' : ''} flex h-[918px] w-[360px] md:w-[640px] flex-col items-center rounded-[30px] bg-brand-main500 p-5 duration-500 preserve-3d scrollbar-y-hidden`}
      onClick={toggleOpen}
    >
