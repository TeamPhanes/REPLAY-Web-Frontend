    ...
    <div className={`${gap} flex`}>
      {options.map((option) => (
        <button
          key={option.value}
          type="button"
          className={`rounded-full border-2 px-4 py-1 text-xl md:text-2xl/[34px] font-normal tracking-[-2.5%] duration-500 ease-in-out hover:bg-white hover:border-mainBlue hover:text-mainBlue ${
