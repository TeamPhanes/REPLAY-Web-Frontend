...
export default function RoutingMenu() {
  ...
  return (
    <div className="flex md:w-[912px] flex-col">
      <div className="mt-16 flex md:justify-between gap-3 md:gap-0 flex-col md:flex-row">
        <Link href="/theme">
          <div className="h-[248px] w-full md:w-[450px] rounded-[28px] bg-homeCard p-8 relative transition-all hover:scale-[102%] hover:border-2 hover:border-white">
            ...
            <Image
              ...
              width={113}
              height={110}
              className="w-20 h-20 md:w-[113px] md:h-[110px] absolute right-8 bottom-6"
            />
          </div>
        </Link>
        <Link href="/gathering">
          <div className="h-[248px] w-full md:w-[450px] rounded-[28px] bg-homeCard p-8 relative transition-all hover:scale-[102%] hover:border-2 hover:border-white">
            ...
            <Image
              ...
              width={96}
              height={96}
              className="w-20 h-20 md:w-[96px] md:h-[96px] absolute right-8 bottom-6"
            />
          </div>
        </Link>
      </div>
        ...
        <Link href="/mypage/favorite?type=room">
          <div className="h-[248px] w-full md:w-[450px] rounded-[28px] bg-homeCard p-8 relative transition-all hover:scale-[102%] hover:border-2 hover:border-white">
            ...
            <Image
              ...
              width={113}
              height={118}
              className="w-20 h-20 md:w-[113px] md:h-[118px] absolute right-8 bottom-6"
            />
          </div>
        </Link>
        <Link href="/mypage/favorite?type=gathering">
          <div className="flex md:h-[248px] w-full md:w-[219px] items-center justify-center rounded-[28px] bg-homeCard p-8 relative transition-all hover:scale-[102%] hover:border-2 hover:border-white">
            ...
            <Image
              ...
              width={56}
              height={56}
              className="w-[56px] h-[56px] absolute right-8 md:right-auto md:top-8"
            />
          </div>
        </Link>
        <div
