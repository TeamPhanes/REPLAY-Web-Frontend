  ...
  return (
    <div className="flex w-[912px] flex-col">
      <div className="mt-16 flex justify-between">
        <Link href="/room">
          <div className="bg-homeCard h-[248px] w-[450px] rounded-[28px] p-8">
            <h2 className="text-5xl font-bold tracking-[-2.5%] text-white">
              방탈출
            </h2>
            <p className="text-homeFont mt-4 w-[338px] text-base font-normal tracking-[-2.5%]">
      ...
      <div className="mt-3 flex justify-between">
        ...
        <div className="bg-homeCard flex h-[248px] w-[219px] items-center justify-center rounded-[28px] p-8">
