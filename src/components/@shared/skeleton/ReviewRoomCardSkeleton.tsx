...
export default function ReviewRoomCardSkeleton({
  ...
  return (
    <div className={`${className} grid grid-cols-1 gap-5 mt-6`}>
      {Array.from({ length: count }).map((_, index) => (
        ...
        >
          ...
          <div className="mt-5 md:mt-auto md:ml-5 flex h-[212px] w-[322px] flex-col justify-between">
          ...
          <div className="hidden ml-10 w-[624px] md:flex flex-col gap-2">
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                <div className="w-16 h-6 bg-white" />
                <div className="w-40 h-6 bg-white" />
            ...
            <div className="flex gap-2">
              <div className="flex items-center justify-center w-[156px] h-[156px] bg-white rounded-3xl shrink-0">
                <svg
                  className="w-10 h-10 text-card"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
