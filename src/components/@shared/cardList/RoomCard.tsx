...
export default function RoomCard({
  ...
  return (
    <div
      key={room.themeId}
      className={`${reviewCheck ? 'w-full' : 'md:w-[630px]'} relative flex md:h-[252px] flex-col md:flex-row items-start rounded-3xl bg-card p-5 transition-all hover:scale-[102%]`}
    >
      <RoomCardSection
        room={room}
